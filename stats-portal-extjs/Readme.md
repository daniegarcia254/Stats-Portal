...
This area is intended for overrides like these:
    ...
    Ext.define('PortalStats.overrides.foo.Bar', {
...
If not toolkit is selected, _classic_ will be loaded by default.

### Build
    sencha app build [classic|modern]

If not toolkit is selected, both _classic_ and _modern_ will be built.

### Add premium packages
Copy the premium package _"{premiumLocation}/ext/packages/{premiumPackage}"_ to the folder _"{appDir}/ext/packages/{premiumPackage}"_.

Open the _"{appDir}/app.json"_ file and add to the _"requires"_ block the premium package:

    "requires": [
        "calendar"
    ],

Go to the _"{appDir}/ext/packages/{premiumPackage}"_ folder and build the package for the themes you seem necessary:
...
# Upgrade ExtJS version
Download the new ExtJS version from the root _"{appDir}"_ execute:
    sencha app upgrade {newExtJSDir/}

Sometimes you'll need to upgrade first as well the version of _SenchaCmd_.
